...
class Detailed(models.Model):
    ...
    service = models.OneToOneField("servicesTable", on_delete=models.CASCADE , null = True) #one service can have many detailed Discription
    Functionality = models.OneToOneField("Functionality",on_delete=models.CASCADE,null=True)
